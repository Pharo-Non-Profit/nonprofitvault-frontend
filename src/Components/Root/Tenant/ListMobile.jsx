                ...
                return <div className="mb-5" key={`mobile_tablet_${datum.id}`}>
                    ...
                    <div className="is-hidden-mobile pt-2" key={`tablet_${datum.id}`}>
                        <div className="buttons is-right">
                            <Link to={`/root/tenant/${datum.id}`} className="button is-small is-primary" type="button">
                                <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View
                            </Link>
                            <div className="column">
                                <Link to={`/root/tenant/${datum.id}/start`} className="button is-small is-success">Start&nbsp;<FontAwesomeIcon icon={faChevronRight} /></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="is-hidden-tablet pt-2" key={`mobile_${datum.id}`}>
                        <div className="columns is-mobile">
                            <div className="column">
                                <Link to={`/root/tenant/${datum.id}`} className="button is-small is-primary is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View
                                </Link>
                            </div>
                            <div className="column">
                                <Link to={`/root/tenant/${datum.id}/start`} className="button is-small is-success is-fullwidth">Start&nbsp;<FontAwesomeIcon icon={faChevronRight} /></Link>
                            </div>
                        </div>
                    </div>
