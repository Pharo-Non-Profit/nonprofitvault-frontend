                            ...
                            return <tr key={`desktop_${tenant.id}`}>
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link to={`/root/tenant/${tenant.id}`} className="button is-small is-primary" type="button">
                                            <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View
                                        </Link>
                                        <Link to={`/root/tenant/${tenant.id}/start`} className="button is-small is-success">Start&nbsp;<FontAwesomeIcon icon={faChevronRight} /></Link>
                                    </div>
                                </td>
                            </tr>;
                        })}
