...
function AdminUserDetailObjectFileListDesktop(props) {
                    ...
                    <tbody>
                        ...
                        {listData && listData.results && listData.results.map(function(attachment, i){
                            return <tr>
                                ...
                                <td data-label="State">{OBJECT_FILE_STATES[attachment.status]}</td>
                                <td data-label="Created">{attachment.createdAt}</td>
                                <td data-label="File">
                                    <a href={attachment.objectUrl} target="_blank" rel="noreferrer" className="">
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link to={`/admin/user/${userID}/attachment/${attachment.id}`} className="button is-small is-primary" type="button">
                                            View
                                        </Link>
                                        <Link to={`/admin/user/${userID}/attachment/${attachment.id}/edit`} className="button is-small is-warning" type="button">
                                            Edit
                                        </Link>
                                        <button onClick={(e, ses) => onSelectObjectFileForDeletion(e, attachment)} className="button is-small is-danger" type="button">
...
export default AdminUserDetailObjectFileListDesktop;
