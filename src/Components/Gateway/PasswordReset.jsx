                                                    ...
                                                    <form>
                                                        ...
                                                        <div className="field">
                                                            ...
                                                            <div className="control has-icons-left has-icons-right">
                                                                <input className={`input ${errors && errors.password && 'is-danger'} ${validation && validation.password && 'is-success'}`}
                                                                        type="password"
                                                        ...
                                                        <div className="field">
                                                            <label className="label is-small has-text-grey-light">Password Repeated</label>
                                                            <div className="control has-icons-left has-icons-right">
                                                                <input className={`input ${errors && errors.passwordRepeated && 'is-danger'} ${validation && validation.passwordRepeated && 'is-success'}`}
                                                                        type="password"
                                                        ...
                                                        <br />
                                                        <button className="button is-medium is-block is-fullwidth is-primary" type="button" onClick={onButtonClick} style={{backgroundColor:"#FF0000"}}>
