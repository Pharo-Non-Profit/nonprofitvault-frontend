...
function CustomerUploadDirectoryUpdate() {
    ////
    //// URL Parameters.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        putUploadDirectoryUpdateAPI(
            decamelizedData,
            onCustomerUploadDirectoryUpdateSuccess,
            onCustomerUploadDirectoryUpdateError,
            onCustomerUploadDirectoryUpdateDone,
            onUnauthorized
        );
    ...
    function onCustomerUploadDirectoryUpdateSuccess(response){
        // For debugging purposes only.
        console.log("onCustomerUploadDirectoryUpdateSuccess: Starting...");
        ...
        setTimeout(() => {
            console.log("onCustomerUploadDirectoryUpdateSuccess: Delayed for 2 seconds.");
            console.log("onCustomerUploadDirectoryUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);

        // Redirect the user to the user attachments page.
        setForceURL("/upload-directory/"+id);
    }

    function onCustomerUploadDirectoryUpdateError(apiErr) {
        console.log("onCustomerUploadDirectoryUpdateError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onCustomerUploadDirectoryUpdateError: Delayed for 2 seconds.");
            console.log("onCustomerUploadDirectoryUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onCustomerUploadDirectoryUpdateDone() {
        console.log("onCustomerUploadDirectoryUpdateDone: Starting...");
        setFetching(false);
    }
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li className=""><Link to="/assistants" aria-current="page"><FontAwesomeIcon className="fas" icon={faCloudUpload} />&nbsp;Documents</Link></li>
                            <li className=""><Link to={`/assistant/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail</Link></li>
...
export default CustomerUploadDirectoryUpdate;
