...
function CustomerUploadDirectoryUploadFileDetail() {
    ////
    //// URL Parameters.
    ////
    ...
    function onUploadFileDeleteSuccess(response){
        ...
        setForceURL("/upload-directory/" + udid + "/upload-files");
    }
            ...
            <div className="container">
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to={`/upload-directory/${udid}/upload-files`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Files)</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav className="box">
                        ...
                        {attachment && <div className="columns">
                            ...
                            <div className="column has-text-right">
                                <Link to={`/upload-directory/${udid}/upload-file/${ufid}/edit`} className="button is-small is-warning is-fullwidth-mobile" type="button" disabled={attachment.status === 2}>
                                ...
                                {attachment && <div className="container">
                                    ...
                                    <div className="columns pt-5">
                                        ...
                                        <div className="column is-half has-text-right">
                                            <Link to={`/upload-directory/${udid}/upload-file/${ufid}/edit`} className="button is-medium is-warning is-fullwidth-mobile" type="button">
...
export default CustomerUploadDirectoryUploadFileDetail;
