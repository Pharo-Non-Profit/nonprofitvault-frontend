...
import CustomerUploadDirectoryUploadFileListDesktop from "./Desktop";
import CustomerUploadDirectoryUploadFileListMobile from "./Mobile";


function CustomerUploadDirectoryUploadFileList() {
    ...
    function onUploadFileDeleteSuccess(response){
        ...
        setTopAlertMessage("UploadFile deleted");
        setTimeout(() => {
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className="is-active"><Link to={`/upload-directory/${udid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail (Files)</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className="">
                                <Link to="/upload-directories" aria-current="page">
                                ...
                                <div className="columns is-vcentered">
                                    <div className="column">
                                        <BubbleLink
                                            ...
                                            faIcon={faPlus}
                                            url={`/upload-directory/${udid}/upload-files/add`}
                                    ...
                                    <div className="column">
                                        <BubbleLink
                                            ...
                                            faIcon={faSearch}
                                            url={`/upload-directory/${udid}/upload-files/search`}
                    ...
                    <nav className="box" style={{ borderRadius: "20px"}}>
                        ...
                        <div className= "tabs is-medium is-size-7-mobile">
                            <ul>
                                <li>
                                    <Link to={`/upload-directory/${udid}`}>Detail</Link>
                                </li>
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerUploadDirectoryUploadFileListDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerUploadDirectoryUploadFileListMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            ...
                                            <p className="subtitle">
                                                No upload files. <b><Link to={`/upload-directory/${udid}/upload-files/add`}>Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating your first upload file.
                                            </p>
                                        </div>
                                    </section>
                                }
                        ...
                        <div className="columns pt-5">
                            <div className="column is-half">
                                <Link className="button is-fullwidth-mobile" to={`/upload-directories`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Documents</Link>
                            </div>
                            <div className="column is-half has-text-right">
...
export default CustomerUploadDirectoryUploadFileList;
