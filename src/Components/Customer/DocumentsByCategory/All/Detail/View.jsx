...
function CustomerUploadDirectoryDetail() {
    ////
    //// URL Parameters.
    ////
                    ...
                    <nav className="box">
                        ...
                        {assistant && <div className="columns">
                            ...
                            <div className="column has-text-right">
                                <Link to={`/upload-directory/${id}/edit`} className="button is-small is-warning is-fullwidth-mobile" type="button" disabled={assistant.status === 2}>
                                ...
                                {assistant && <div className="container">
                                    ...
                                    <div className= "tabs is-medium is-size-7-mobile">
                                        <ul>
                                            ...
                                            <li>
                                                <Link to={`/upload-directory/${id}/upload-files`}>Files</Link>
                                            </li>
                                    ...
                                    <div className="columns pt-5">
                                        ...
                                        <div className="column is-half has-text-right">
                                            <Link to={`/upload-directory/${id}/edit`} className="button is-medium is-warning is-fullwidth-mobile" type="button"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit</Link>
                                        </div>
                                    </div>
...
export default CustomerUploadDirectoryDetail;
