...
function CustomerDocumentCategoryAllListDesktop(props) {
                            ...
                            return <tr>
                                ...
                                <td className="is-actions-cell">
                                    <div className="buttons is-right">
                                        <Link to={`/upload-directory/${datum.id}`} className="is-small">
...
export default CustomerDocumentCategoryAllListDesktop;
