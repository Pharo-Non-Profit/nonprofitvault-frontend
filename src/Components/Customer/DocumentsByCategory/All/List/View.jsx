...
import { faCloudUpload, faFilterCircleXmark,faArrowLeft, faCloud, faTachometer, faEye, faPencil, faTrashCan, faPlus, faGauge, faArrowRight, faTable, faArrowUpRightFromSquare, faRefresh, faFilter, faSearch } from '@fortawesome/free-solid-svg-icons';
...
import CustomerDocumentCategoryAllListDesktop from "./Desktop";
import CustomerDocumentCategoryAllListMobile from "./Mobile";


function CustomerDocumentCategoryAllList() {
    ...
    const onSelectObjectFileForDeletion = (e, user) => {
        console.log("onSelectObjectFileForDeletion", user);
        setSelectedObjectFileForDeletion(user);
    }
                ...
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul className="">
                            ...
                            <li className="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faCloud} />&nbsp;Cloud Documents</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div className="columns is-vcentered">
                                    <div className="column">
                                        <BubbleLink
                                            ...
                                            subtitle={`Upload a new document into the cloud`}
                                            faIcon={faCloudUpload}
                                            url={`/upload-directories/add`}
                                    ...
                                    <div className="column">
                                        <BubbleLink
                                            title={`Search`}
                                            subtitle={`Search all cloud documents`}
                                            faIcon={faSearch}
                                            url={`/upload-directoriess/search`}
                    ...
                    <div className={`modal ${selectedObjectFileForDeletion ? 'is-active' : ''}`}>
                        ...
                        <div className="modal-card">
                            ...
                            <section className="modal-card-body">
                                You are about to <b>archive</b> this directory and all the contents in it; it will no longer appear on your dashboard This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?
                            </section>
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                    ...
                                    <div className="container">
                                        ...
                                        */}
                                        <div className="is-hidden-touch" >
                                            <CustomerDocumentCategoryAllListDesktop
                                                listData={listData}
                                                listCount={listCount}
                                        ...
                                        */}
                                        <div className="is-fullwidth is-hidden-desktop">
                                            <CustomerDocumentCategoryAllListMobile
                                                listData={listData}
                                                listCount={listCount}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                    ...
                                    <section className="hero is-medium has-background-white-ter">
                                        <div className="hero-body">
                                            <p className="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No Documents in Cloud
                                            </p>
                                            <p className="subtitle">
                                                No documents. <b><Link to="/documents/add">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating upload your first document.
                                            </p>
                                        </div>
                                    </section>
                                }
...
export default CustomerDocumentCategoryAllList;
