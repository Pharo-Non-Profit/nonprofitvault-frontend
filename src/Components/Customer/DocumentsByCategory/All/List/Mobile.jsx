...
*/
function CustomerDocumentCategoryAllListMobile(props) {
    const { listData, listCount, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, onSelectClientForDeletion } = props;
    return (
        <>
            {listData && listData.results && listData.results.map(function(datum, i){
                return <div className="mb-5">
                    ...
                    <br />
                    <br />
                    <Link to={`/upload-directory/${datum.id}`} className="button is-primary is-fullwidth-mobile" type="button">
...
export default CustomerDocumentCategoryAllListMobile;
