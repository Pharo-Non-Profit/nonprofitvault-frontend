...
function CustomerUploadDirectoryAdd() {
    ////
    //// Global state.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        postUploadDirectoryCreateAPI(
            decamelizedData,
            onCustomerUserUploadDirectoryAddSuccess,
            onCustomerUserUploadDirectoryAddError,
            onCustomerUserUploadDirectoryAddDone,
            onUnauthorized
        );
    ...
    function onCustomerUserUploadDirectoryAddSuccess(response){
        // For debugging purposes only.
        console.log("onCustomerUserUploadDirectoryAddSuccess: Starting...");
        ...
        setTimeout(() => {
            console.log("onCustomerUserUploadDirectoryAddSuccess: Delayed for 2 seconds.");
            console.log("onCustomerUserUploadDirectoryAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);

        // Redirect the user to the user attachments page.
        setForceURL("/upload-directory/"+response.id);
    }

    function onCustomerUserUploadDirectoryAddError(apiErr) {
        console.log("onCustomerUserUploadDirectoryAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onCustomerUserUploadDirectoryAddError: Delayed for 2 seconds.");
            console.log("onCustomerUserUploadDirectoryAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onCustomerUserUploadDirectoryAddDone() {
        console.log("onCustomerUserUploadDirectoryAddDone: Starting...");
        setFetching(false);
    }
            ...
            <div className="container">
                <section className="section">
                    ...
                    <nav className="breadcrumb has-background-light p-4 is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li className=""><Link to={`/upload-directories`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Documents</Link></li>
                        </ul>
                    </nav>

                    {/* Page Name */}
                    <h1 className="name is-2"><FontAwesomeIcon className="fas" icon={faCloudUpload} />&nbsp;Documents</h1>
                                ...
                                <div className="container">
                                    ...
                                    <div className="columns pt-5">
                                        <div className="column is-half">
                                            <Link to={`/upload-directories`} className="button is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Documents
                                            </Link>
                                        </div>
...
export default CustomerUploadDirectoryAdd;
