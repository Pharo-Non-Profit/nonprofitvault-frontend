            ...
            <nav className="navbar has-background-black" role="navigation" aria-label="main navigation" >
                <div className="navbar-brand">
                    {(currentUser.roleId === EXECUTIVE_ROLE_ID || currentUser.roleId === MANAGEMENT_ROLE_ID) &&
                        <>{onHamburgerClicked === false && <Link className="navbar-item" href="/admin/dashboard" style={{color:"white"}}>
                           <img src="/img/compressed-logo.png" width={112} height={28} alt="Logo Image" />
                        </Link>
                    }</>
                    }
                    <a role="button" className="navbar-burger has-text-white" aria-label="menu" aria-expanded="false" data-target="navbarBasicExample" onClick={(e)=>setOnHamburgerClicked(!onHamburgerClicked)}>
                ...
                <div id="navbarBasicExample" className="navbar-menu has-text-white">
                    <div className="navbar-left">
                        <div className="navbar-item">
                            <div className="buttons p-3" onClick={(e)=>setOnHamburgerClicked(!onHamburgerClicked)}>
