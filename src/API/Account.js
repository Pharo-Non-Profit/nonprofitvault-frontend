...
import {
    NONPROFITVAULT_ACCOUNT_API_ENDPOINT,
    NONPROFITVAULT_ACCOUNT_CHANGE_PASSWORD_API_ENDPOINT,
    NONPROFITVAULT_ACCOUNT_AVATAR_OPERATION_API_ENDPOINT
} from "../Constants/API";


export function getAccountDetailAPI(onSuccessCallback, onErrorCallback, onDoneCallback) {
    const axios = getCustomAxios();
    axios.get(NONPROFITVAULT_ACCOUNT_API_ENDPOINT).then((successResponse) => {
...
export function putAccountUpdateAPI(data, onSuccessCallback, onErrorCallback, onDoneCallback) {
    ...
    axios.put(NONPROFITVAULT_ACCOUNT_API_ENDPOINT, decamelizedData).then((successResponse) => {
        const responseData = successResponse.data;
...
export function putAccountChangePasswordAPI(decamelizedData, onSuccessCallback, onErrorCallback, onDoneCallback) {
    ...
    axios.put(NONPROFITVAULT_ACCOUNT_CHANGE_PASSWORD_API_ENDPOINT, decamelizedData).then((successResponse) => {
        const responseData = successResponse.data;
...
export function postAccountAvatarAPI(formdata, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    ...
    axios.post(NONPROFITVAULT_ACCOUNT_AVATAR_OPERATION_API_ENDPOINT, formdata, {
        headers: {
