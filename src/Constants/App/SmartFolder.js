...
// ------ Personal Category ------
export const SMART_FOLDER_PERSONAL_SUB_CATEGORY_PROOF_OF_PURCHASE = 1000;
export const SMART_FOLDER_PERSONAL_SUB_CATEGORY_HOME_OWNERSHIP = 1001;
export const SMART_FOLDER_PERSONAL_SUB_CATEGORY_OPTIONS = [
    { value: SMART_FOLDER_PERSONAL_SUB_CATEGORY_PROOF_OF_PURCHASE, label: 'Proof of Purchase' },
