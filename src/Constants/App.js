...
export const DEFAULT_USER_LIST_SORT_BY_VALUE = "lexical_name,ASC";
export const DEFAULT_USER_STATUS_FILTER_OPTION = 1; // 1=Active

export const USER_PHONE_TYPE_LANDLINE = 1
export const USER_PHONE_TYPE_MOBILE = 2
export const USER_PHONE_TYPE_WORK = 3

export const USER_ORGANIZATION_TYPE_UNKNOWN = 1
export const USER_ORGANIZATION_TYPE_PRIVATE = 2
export const USER_ORGANIZATION_TYPE_NON_PROFIT = 3
export const USER_ORGANIZATION_TYPE_GOVERNMENT = 4
...
export const DEFAULT_ORDER_LIST_SORT_BY_VALUE = "assignment_date,DESC";
...
export const OBJECT_FILE_STATUS_ACTIVE = 1
export const OBJECT_FILE_STATUS_ARCHIVED = 2

export const OBJECT_FILE_TYPE_CUSTOMER = 1
export const OBJECT_FILE_TYPE_ASSOCIATE = 2
export const OBJECT_FILE_TYPE_ORDER = 3
export const OBJECT_FILE_TYPE_STAFF = 4
...
export const DEFAULT_INSURANCE_REQUIREMENT_LIST_SORT_BY_VALUE = "created_at,DESC";
...
export const DEFAULT_INACTIVE_USER_LIST_SORT_BY_VALUE = "join_date,DESC";
export const DEFAULT_INACTIVE_USER_STATUS_FILTER_OPTION = 2; // 2=Archived
...
export const ASSISTANT_THREAD_STATUS_ACTIVE = 1
export const ASSISTANT_THREAD_STATUS_QUEUED = 2
export const ASSISTANT_THREAD_STATUS_ERROR = 3
export const ASSISTANT_THREAD_STATUS_ARCHIVED = 4

export const DEFAULT_ASSISTANT_LIST_SORT_BY_VALUE = "created_at,DESC";
export const DEFAULT_ASSISTANT_FILE_LIST_SORT_BY_VALUE = "created_at,DESC";
export const DEFAULT_CLIENT_LIST_SORT_BY_VALUE = "created_at,DESC";

export const RESIDENTIAL_USER_TYPE_OF_ID = 1;
export const COMMERCIAL_USER_TYPE_OF_ID = 2;
