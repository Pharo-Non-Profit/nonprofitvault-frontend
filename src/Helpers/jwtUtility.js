...
import { NONPROFITVAULT_LOGIN_API_ENDPOINT, NONPROFITVAULT_REFRESH_TOKEN_API_URL } from "../Constants/API";
...
export function setAccessTokenInLocalStorage(accessToken) {
    if (accessToken !== undefined && accessToken !== null) {
        localStorage.setItem("NONPROFITVAULT_TOKEN_UTILITY_ACCESS_TOKEN_DATA", accessToken);
    } else {
...
export function setRefreshTokenInLocalStorage(accessToken) {
    if (accessToken !== undefined && accessToken !== null)  {
        localStorage.setItem("NONPROFITVAULT_TOKEN_UTILITY_REFRESH_TOKEN_DATA", accessToken);
    } else {
...
export function getAccessTokenFromLocalStorage() {
    return localStorage.getItem("NONPROFITVAULT_TOKEN_UTILITY_ACCESS_TOKEN_DATA");
}
...
export function getRefreshTokenFromLocalStorage() {
    return localStorage.getItem("NONPROFITVAULT_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
...
export function clearAllAccessAndRefreshTokensFromLocalStorage() {
    localStorage.removeItem("NONPROFITVAULT_TOKEN_UTILITY_ACCESS_TOKEN_DATA");
    localStorage.removeItem("NONPROFITVAULT_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
...
function atteptLogin(email, password) {
    return axios.post(NONPROFITVAULT_LOGIN_API_ENDPOINT, {
        'email': email,
        'password': password,
    })
}
...
function atteptRefresh(refreshTokenString) {
    return axios.post(NONPROFITVAULT_REFRESH_TOKEN_API_URL, {
