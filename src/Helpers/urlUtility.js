import { NONPROFITVAULT_API_BASE_PATH } from "../Constants/API";
...
export function getAPIBaseURL() {
    return process.env.REACT_APP_API_PROTOCOL + "://" + process.env.REACT_APP_API_DOMAIN + NONPROFITVAULT_API_BASE_PATH;
}
